...
<body>
    ...
    <input type="hidden" value="<?= $this->session->flashdata('tipo_retorno_funcao'); ?>" class="retorno-funcao"
        data-texto="<?= $this->session->flashdata('texto_retorno_funcao'); ?>"
        data-titulo="<?= $this->session->flashdata('titulo_retorno_funcao'); ?>"
        data-redirect="<?= $this->session->flashdata('redirect_retorno_funcao'); ?>">
                                    ...
                                    if (in_array($v['id'], $this->session->userdata('permissao'))) { // Apenas os menu liberado para o usuário logado
                                        if (!empty($v['icone'])): // Mostrar quando ter icone
                                            ...
                                            if (!empty($v['link'])) { // categoria normal 
                                                ?>
                                                <a class="nav-link label-1" href="<?= base_url($v['link']) ?>" role="button"
                                            ...
                                            <?php } else { // categoria PAI - FILHOS 
                                                ...
                                                <div class="nav-item-wrapper">
                                                    ...
                                                    <a class="nav-link dropdown-indicator label-" href="#ref-<?= $v['id'] ?>"
            ...
            <div class="navbar-vertical-footer">
                <button
                    class="btn navbar-vertical-toggle border-0 fw-semi-bold w-100 white-space-nowrap d-flex align-items-center"><span
                        ...
                        class="navbar-vertical-footer-text ms-2">Esconder Menu</span></button>
            </div>
        </nav>
                ...
                <ul class="navbar-nav navbar-nav-icons flex-row">
                    ...
                    <li class="nav-item">
                        <div class="theme-control-toggle fa-icon-wait px-2">
                            ...
                            <label class="altera-logo-tema mb-0 theme-control-toggle-label theme-control-toggle-light"
                                for="themeControlToggle" data-bs-toggle="tooltip" data-bs-placement="left"
                                title="Alterar Tema"><span class="icon" data-feather="moon"></span></label>
                            <label class="altera-logo-tema mb-0 theme-control-toggle-label theme-control-toggle-dark"
                                for="themeControlToggle" data-bs-toggle="tooltip" data-bs-placement="left"
                                title="Alterar Tema"><span class="icon" data-feather="sun"></span></label>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
                            ...
                            <div class="avatar avatar-l ">
                                <img class="rounded-circle "
                                    src="<?= $this->session->userdata('foto_perfil') != '' ? base_url_upload('usuarios/') . $this->session->userdata('foto_perfil') : base_url('assets/img/icons/sem_foto.jpg') ?>"
                                    alt="" />
                            ...
                            <div class="card position-relative border-0">
                                    ...
                                    <ul class="nav d-flex flex-column mb-2 pb-1">
                                        <?php if ($this->session->userdata("id_setor") != 0) { ?>
                                            <li class="nav-item"><a class="nav-link px-3"
                                                    href="<?= base_url('usuarios/formulario/' . $this->session->userdata("id_usuario")) ?>">
                                                    <span class="me-2 text-900"
                                                        data-feather="user"></span><span>Perfil</span></a></li>
                                            <li class="nav-item"><a class="nav-link px-3"
                                                    href="https://api.whatsapp.com/send?l=pt_br&phone=5514997501274"> <span
                                                        class="me-2 text-900" data-feather="help-circle"></span>Central de
                                                    Ajuda</a></li>
                                        <?php } ?>
                                        <li class="nav-item"><a class="nav-link px-3"
                                                href="<?= base_url('dashboard') ?>"><span class="me-2 text-900"
                                                    data-feather="pie-chart"></span>Painel Principal</a></li>
                                        <li class="nav-item"><a class="nav-link px-3"
                                                href="<?= base_url('usuarios/formulario') ?>"><span
                                                    class="me-2 text-900" data-feather="user-plus"></span>Criar outra
                                                conta</a></li>
                                ...
                                <div class="card-footer p-3 border-top">
                                    <div class="px-3"> <a class="btn btn-phoenix-secondary d-flex flex-center w-100"
                                            href="<?= base_url('login/sair') ?>"> <span class="me-2"
                                                data-feather="log-out"> </span>Sair</a></div>
                                </div>
                            </div>
                        </div>
                    </li>
