            ...
            <div class="row align-items-center gx-0 gy-7">
              <div class="col-auto bg-100 dark__bg-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                ...
                <div class="position-relative z-index--1 mb-6 d-none d-md-block text-center mt-md-5">
                  <img class="auth-title-box-img d-dark-none" src="<?= base_url('assets/img/spot-illustrations/auth.png') ?>" alt="" />
                  <img class="auth-title-box-img d-light-none" src="<?= base_url('assets/img/spot-illustrations/auth-dark.png') ?>" alt="" />
                </div>
                ...
                <div class="auth-form-box">
                  <div class="text-center">
                    ...
                    <div class="d-flex align-items-center mb-5">
                      ...
                      <button type="submit" class="btn btn-success btn-padrao ms-2" onclick="verificaEmail()">Enviar<span class="fas fa-chevron-right ms-2"></span></button>
                    </div><a class="fs--1 fw-bold text-dark" href="#">Lembrei a senha!</a>
                  </div>
                </div>
              </div>
              ...
              <div class="col mx-auto d-none div-codigo">
                <div class="auth-form-box">
                  <div class="text-center"><a class="d-flex flex-center text-decoration-none mb-4" href="#">
                    ...
                    <p class="text-700 mb-0">Um código de verificação de 6 dígitos foi enviado para seu email</p>
                    <div class="verification-form" data-2fa-varification="data-2FA-varification">
                      ...
                      <button onclick="verificaCodigo()" class="btn btn-success w-100 mb-5 btn-padrao">Verificar</button>
                    </div>
                  </div>
                </div>
              </div>
