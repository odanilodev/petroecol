        ...
        <div class="row align-items-center justify-content-between g-3 mb-4">
            ...
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?= base_url("motoristas/formulario") ?>" class="btn btn-primary"><span class="fas fa-plus me-2"></span>Adicionar Motorista</a>
                </div>
            </div>
            ...
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                        <input class="form-control search-input search" type="search" placeholder="Buscar Motoristas" aria-label="Search" />
                ...
                <table class="table table-sm fs--1 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="sort align-middle" scope="col" data-sort="email">Validade da CNH</th>
                            <th class="sort align-middle" scope="col" data-sort="email">CPF</th>
                            <th class="sort align-middle pe-3" scope="col" data-sort="mobile_number">Download CNH</th>
                                ...
                                <td class="customer align-middle white-space-nowrap">
                                    <a class="d-flex align-items-center text-900" href="#!">
                                        <div class="avatar avatar-m">
                                            <img class="rounded-circle" src="<?= $v['foto_perfil'] ? base_url('uploads/motoristas/perfil/' . ($v['foto_perfil'])) : base_url('assets/img/icons/sem_foto.jpg') ?>">
                                        </div>
