            ...
            <div class="row align-items-center justify-content-between g-3 mb-4">
                ...
                <div class="col-auto">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="<?= base_url("cargos/formulario/") ?>" class="btn btn-primary"><span class="fas fa-plus me-2"></span>Adicionar Cargo</a>
                    </div>
                </div>
                ...
                <div class="col col-auto">
                    <div class="search-box">
                        <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                            <input class="form-control search-input search" type="search" placeholder="Buscar Cargos" aria-label="Search" />
                            ...
                            <?php foreach ($cargos as $v) { ?>
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle white-space-nowrap">
                                        <i data-feather="check-circle" class="<?= ($v['responsavel_agendamento'] == 1) ? 'text-success' : '' ?>"></i>
                                    </td>

                                    <td class="align-middle white-space-nowrap">
                                        <a href="<?= base_url('cargos/formulario/' . $v['id']) ?>" class="btn btn-info">
                                            <span class="fas fa-pencil ms-1"></span>
                                        </a>
                                    </td>

                                    <td class="align-middle white-space-nowrap">
                                        <a href="#" class="btn btn-danger" onclick="deletaCargos(<?= $v['id'] ?>)">
