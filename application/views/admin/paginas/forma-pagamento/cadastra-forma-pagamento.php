                ...
                <div class="card-header p-4 border-bottom border-300 bg-soft">
                    <div class="row g-3 justify-content-between align-items-center">
                        <div class="col-12 col-md">
                            <h4 class="text-900 mb-0"><?= $this->uri->segment(3) ? 'Editar Forma de Pagamento' : 'Adicionar uma nova Forma de Pagamento'; ?></h4>
                                        ...
                                        <div class="card theme-wizard mb-5" data-theme-wizard="data-theme-wizard">
                                            ...
                                            <div class="card-body pt-4 pb-0 row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input class="form-control input-nome campo-obrigado" type="text" placeholder="Nome da Forma de Pagamento" value="<?= $forma_pagamento['forma_pagamento'] ?? ''; ?>">
                                                </div>
