                ...
                <div class="col col-auto">
                    <div class="search-box">
                        <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                            <input class="form-control search-input search" type="search" placeholder="Buscar Alertas" aria-label="Search" />
                    ...
                    <table class="table table-sm fs--1 mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="sort align-middle" scope="col" data-sort="customer">Título</th>
                                <th class="sort align-middle">Texto</th>
                                <th class="sort align-middle">Status</th>
                                <th class="sort align-middle">Editar</th>
                                <th class="sort align-middle">Excluir</th>
                        ...
                        <tbody class="list" id="members-table-body">
                            ...
                            <?php foreach ($alertas as $v) { ?>
                                <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                    ...
                                    <td class="align-middle white-space-nowrap">
                                        <a href="#" class="btn btn-danger" onclick="deletaAlertaWhatsapp(<?= $v['id'] ?>)">
