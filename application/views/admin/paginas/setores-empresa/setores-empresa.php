<div class="content">
    <div id="members" data-list='{"valueNames":["setor-empresa-nome"],"page":10,"pagination":true}'>
        <div class="row align-items-center justify-content-between g-3 mb-4">
            ...
            <div class="col-auto">
                <div class="d-flex align-items-center">
                    ...
                    <a href="<?= base_url("setoresEmpresa/formulario") ?>" class="btn btn-primary"><span class="fas fa-plus me-2"></span>Adicionar Setor Empresa</a>
                </div>
            </div>
            ...
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                        <input class="form-control search-input search" type="search" placeholder="Buscar Setor Empresa" aria-label="Search" />
                ...
                <table class="table table-sm fs--1 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="sort align-middle" scope="col" data-sort="setor-empresa-nome">Setor Empresa</th>
                        ...
                        <?php foreach ($setoresEmpresa as $v) { ?>
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                ...
                                <td class="fs--1 align-middle ps-0 py-3">
                                    <div class="form-check mb-0 fs-0">
                                          <input class="form-check-input" type="checkbox" data-bulk-select-row='{"setor-empresa-nome"}' />
                                    </div>
                                </td>

                                <td class="setor-empresa-nome align-middle white-space-nowrap">
                                    <?= $v['nome'] ?>
                                </td>

                                <td class="align-middle white-space-nowrap">
                                    <a href="<?= base_url('setoresEmpresa/formulario/' . $v['id']) ?>" class="btn btn-info">
                                        <span class="fas fa-pencil ms-1"></span>
                                    </a>
                                </td>

                                <td class="align-middle white-space-nowrap">
                                    <a href="#" class="btn btn-danger" onclick="deletarSetorEmpresa(<?= $v['id'] ?>)">
