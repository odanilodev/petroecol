        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header border-200 p-4">
                    <h5 class="modal-title text-1000 fs-2 lh-sm" id="reportsFilterModalLabel">Filtrar</h5>
                    <button type="button" class="btn p-1 text-danger" data-bs-dismiss="modal" aria-label="Close">
                ...
                <form action="<?= base_url('clientes') ?>" method="POST" id="addEventForm" autocomplete="off" style="display:contents;">
                    <div class="modal-body pt-4 pb-2 px-4" >
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-cidade-cliente" name="cidade" class="form-select select2">
                                <option value="all" selected>--</option>
                        ...
                        <!-- Rua (escondido por padrão) -->
                        <div class="mb-3">
                            <label class="fw-bold mb-2 text-1000">Rua</label>
                            <select name="rua" id="idRuasCidade" class="form-select select2">
                                <option value="all" selected>--</option>
                                <?php foreach ($ruasCidade as $ruaCidade) { ?>
                                    <option <?= ($cookie_filtro_clientes['rua'] ?? null) == $ruaCidade['rua'] ? 'selected' : '' ?> value="<?= $ruaCidade['rua'] ?>"><?= $ruaCidade['rua'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        ...
                        <!-- Recipientes -->
                        <div class="mb-3">
                            <label class="fw-bold mb-2 text-1000">Recipientes</label>
                        ...
                        <!-- Etiquetas -->
                        <div class="mb-3">
                            <label class="fw-bold mb-2 text-1000">Etiquetas</label>
                        ...
                        <!-- Resíduos -->
                        <div class="mb-3">
                            <label class="fw-bold mb-2 text-1000">Resíduos</label>
                        ...
                        <!-- Grupos -->
                        <div class="mb-3">
                            <label class="fw-bold mb-2 text-1000">Grupos</label>
                    ...
                    <div class="modal-footer d-flex justify-content-end align-items-center px-4 pb-4 border-1 pt-3">
                        <button class="btn btn-phoenix-primary" type="submit">Buscar clientes</button>
                    </div>
                </form>
            </div>
        </div>
