                    ...
                    <div class="flex-1">
                      ...
                      <div class="d-flex justify-content-between flex-column flex-xl-row mb-2 mb-sm-0">
                        ...
                        <div style="margin-right: 10px;">
                          <button onclick="emailsCertificadoColeta(<?= $coleta['ID_COLETA'] ?>, <?= $this->uri->segment(3) ?>)" class="btn btn-phoenix-success <?= $coleta['coletado'] ? "" : "d-none" ?> " title="Enviar Certificado" data-bs-toggle="modal" data-bs-target=".modal-certificado-coleta">
                            <span class="ui uil-message text-sucess"></span>
                          </button>
                        </div>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <span class="btn btn-primary btn-gerar-certificado enviar-certificado" data-id-cliente="<?= $this->uri->segment(3) ?>"><i class="uil-message"></i> Enviar Certificado</span>
