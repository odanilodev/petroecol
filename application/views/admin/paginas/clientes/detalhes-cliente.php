                    ...
                    <div class="flex-1">
                      ...
                      <div class="d-flex justify-content-between flex-column flex-xl-row mb-2 mb-sm-0">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end p-0" style="z-index: 9999;">
                          ...
                          <li>
                            <a href="#" class="dropdown-item cursor-pointer" onclick="emailsCertificadoColeta(<?= $coleta['ID_COLETA'] ?>, <?= $this->uri->segment(3) ?>)" title="Enviar Certificado" data-bs-toggle="modal" data-bs-target=".modal-certificado-coleta">
                          ...
                          <li>
                            <a class="dropdown-item cursor-pointer" onclick="detalhesHistoricoColeta(<?= $coleta['ID_COLETA'] ?>)" title="Ver Detalhes" data-bs-toggle="modal" data-bs-target=".modal-historico-coleta">
                          ...
                          <li>
                            <a class="dropdown-item cursor-pointer" onclick="recebeDadosColeta(<?= $coleta['ID_COLETA'] ?>, <?= $this->uri->segment(3) ?>)" title="Editar Coleta" data-bs-toggle="modal" data-bs-target=".modal-editar-coleta">
                          ...
                          <li>
                            <a class="dropdown-item cursor-pointer" onclick="deletaColeta(<?= $coleta['ID_COLETA'] ?>, <?= $this->uri->segment(3) ?>)" title="Deletar Coleta">
