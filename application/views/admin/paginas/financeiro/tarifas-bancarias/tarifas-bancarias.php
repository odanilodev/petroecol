<div class="content">
  <div id="members" data-list='{"valueNames":["nome-tarifa"],"page":10,"pagination":true}'>
    <div class="row align-items-center justify-content-between g-3 mb-4">
      ...
      <div class="col-auto">
        <div class="d-flex align-items-center">
          ...
          <a href="<?= base_url("finTarifasBancarias/formulario") ?>" class="btn btn-primary"><span class="fas fa-plus me-2"></span>Adicionar Tarifa Bancaria</a>
        </div>
      ...
      <div class="col col-auto">
        <div class="search-box">
          <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
            <input class="form-control search-input search" type="search" placeholder="Buscar Tarifas" aria-label="Search" />
          ...
          <tbody class="list" id="members-table-body">
            ...
            <?php foreach ($tarifas as $v) { ?>
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="align-middle white-space-nowrap">
                  <a href="<?= base_url('finTarifasBancarias/formulario/' . $v['id']) ?>" class="btn btn-info">
                    <span class="fas fa-pencil ms-1"></span>
                  </a>
                </td>

                <td class="align-middle white-space-nowrap">
                  <a href="#" class="btn btn-danger" onclick="deletaTarifaBancaria(<?= $v['id'] ?>)">
