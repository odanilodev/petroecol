<div class="content">
  <div id="members" data-list='{"valueNames":["nome-macro"],"page":10,"pagination":true}'>
      ...
      <div class="col col-auto">
        <div class="search-box">
          <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
            <input class="form-control search-input search" type="search" placeholder="Buscar Macros" aria-label="Search" />
        ...
        <table class="table table-sm fs--1 mb-0">
          <thead>
            <tr>
              ...
              <th class="sort align-middle pe-3">Micro</th>
          ...
          <tbody class="list" id="members-table-body">
            ...
            <?php foreach ($macros as $v) { ?>
              <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                ...
                <td class="align-middle white-space-nowrap">
                  <a href="#" class="btn btn-danger" onclick="deletaMacro(<?= $v['id'] ?>)">
