<div class="content">
    ...
    <div class="mx-n4 px-4 px-lg-6 bg-white pt-7 border-y border-300 mb-5">
        <div id="members"
            data-list='{"valueNames":["td_vencimento","td_valor", "td_valor_recebido","td_status","td_data_recebimento","td_recebido" ],"page":10,"pagination":true}'>
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="sort text-start ps-5 align-middle text-center" scope="col" data-sort="td_status">
                                Status</th>
                            <th class="sort white-space-nowrap align-middle text-center" scope="col"
                                data-sort="td_data_recebimento">Data
                                Recebimento</th>
                            ...
                            <tr class="hover-actions-trigger btn-reveal-trigger position-static">
                                ...
                                <td class="align-middle white-space-nowrap fs--2 text-center td_valor_recebido">
                                    <h6 class="mb-0 text-900 valor-recebido-<?= $contaReceber['id'] ?>"
                                        value="<?= $contaReceber['valor_recebido'] ?>">
                                    ...
                                    <div class="font-sans-serif btn-reveal-trigger position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                            ...
                                            <?php if (!$contaReceber['status']) { ?>
                                                ...
                                                <a class="dropdown-item receber-conta" data-id="<?= $contaReceber['id'] ?>"
                                                    href="#!" data-bs-toggle="modal" data-bs-target="#modalReceberConta">Receber
                                                    Conta</a>
                                            <?php } ?>
                                        </div>
                                    </div>
