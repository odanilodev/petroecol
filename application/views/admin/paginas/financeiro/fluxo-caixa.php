                    ...
                    <div class="col-12 col-md-3">
                        <div class="d-flex align-items-center">
                            <span class="fa-stack" style="min-height: 46px;min-width: 46px;">
                                <span class="fa-solid fa-square fa-stack-2x text-secondary-300" data-fa-transform="down-4 rotate--10 left-4"></span>
                                <span class="fa-solid fa-circle fa-stack-2x stack-circle text-secondary-100" data-fa-transform="up-4 right-3 grow-2"></span>
                                <span class="fa-stack-1x fa-solid fas fa-dollar-sign text-secondary " data-fa-transform="shrink-2 up-8 right-6"></span>
                            </span>
                            <div class="ms-3">
                ...
                <table class="table fs--1 mb-0 border-top border-200">
                    <thead>
                        <tr class="text-center">
                            ...
                            <th class="sort white-space-nowrap align-middle text-center" scope="col" data-sort="data">Data</th>
                                        ...
                                        <div class="row mx-0 mx-sm-3 mx-lg-0 px-lg-0">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input class="form-control datetimepicker input-fluxo-obrigatorio input-coleta" required name="data_movimentacao" type="text" placeholder="dd/mm/aaaa" data-options='{"disableMobile":true,"allowInput":true, "dateFormat": "d/m/Y"}' style="cursor: pointer;" />
                                                    <div class="d-none aviso-obrigatorio">Preencha este campo</div>
