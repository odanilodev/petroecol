                    ...
                    <thead>
                        <tr class="text-center">
                            ...
                            <th class="sort white-space-nowrap align-middle text-center" scope="col"
                                data-sort="td_data">Data</th>
                            <th class="sort align-middle text-center" scope="col" data-sort="td_recebido">Pago/Recebido
                            </th>
                            <th class="sort align-middle text-center" scope="col" data-sort="td_transacao">Forma de
                                Transação</th>
                            ...
                            <th class="sort ps-5 align-middle text-center" scope="col" data-sort="td_observacao">
                                Observação</th>
                                    ...
                                    <div class="font-sans-serif btn-reveal-trigger position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end py-2">
                                            ...
                                            <a class="dropdown-item" href="#!"
                                                onclick="deletarFluxo(<?= $movimentacao['id']; ?>, <?= $movimentacao['id_conta_bancaria']; ?>, <?= $movimentacao['valor']; ?>, <?= $movimentacao['movimentacao_tabela'] ?>)">
                                                ...
                                                <table class="w-100 table-stats">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="py-2">
                                                            ...
                                                            <div
                                                                class="ps-6 ps-sm-0 fw-semi-bold mb-0 text-break setor-empresa html-clean">
                                        ...
                                        <div class="row mx-0 mx-sm-3 mx-lg-0 px-lg-0">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <select
                                                        class="form-select input-fluxo-obrigatorio select-setor-empresa"
                                                        name="setorEmpresa">
                                                        <option selected disabled>Selecione</option>
