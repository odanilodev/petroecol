<div class="content">
    <div id="members"
        data-list='{"valueNames":["apelido"],"page":10,"pagination":true}'>
            ...
            <div class="col col-auto">
                <div class="search-box">
                    <form class="position-relative" data-bs-toggle="search" data-bs-display="static">
                        <input class="form-control search-input search" type="search" placeholder="Buscar Conta Bancaria"
                            aria-label="Search" />
                ...
                <table class="table table-sm fs--1 mb-0">
                    <thead>
                        <tr>
                            ...
                            <th class="sort align-middle" scope="col" data-sort="apelido">Apelido Conta Bancária</th>
