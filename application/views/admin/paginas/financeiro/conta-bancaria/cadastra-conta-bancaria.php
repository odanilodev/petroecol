                  ...
                  <form method="post" class="needs-validation" novalidate="novalidate" data-wizard-form="1">
                    ...
                    <div class="row">
                      <div class="mb-5 col-md-4">
                        ...
                        <input required value="<?= $contaBancaria['apelido'] ?? "" ?>"
                          class="form-control input-obrigatorio input-apelido" type="text" id="apelido"
                          placeholder="Apelido da Conta Bancaria" />
                      ...
                      <div class="mb-2 col-md-4">
                        ...
                        <input value="<?= $contaBancaria['agencia'] ?? "" ?>"
                          class="form-control input-obrigatorio input-agencia mascara-agencia" type="text" id="agencia"
                      ...
                      <div class="mb-2 col-md-4">
                        ...
                        <input required value="<?= $contaBancaria['conta'] ?? "" ?>"
                          class="form-control input-obrigatorio input-conta mascara-conta-bancaria" type="text"
                          id="conta" placeholder="Digite o nº da conta" />
                        <div class="d-none aviso-obrigatorio">Preencha este campo.</div>
                      </div>
                      ...
                      <?php if (!$this->uri->segment(3)): ?>
                        <div class="mb-2 col-md-4">
                          ...
                          <input value="<?= $saldoBancario['saldo'] ?? "" ?>"
                            class="form-control mascara-dinheiro input-obrigatorio input-saldo" type="text" id="saldo"
