...
class FinFluxo_model extends CI_Model
{
    ...
    {
        $this->db->select('fin_fluxo.*, fin_contas_bancarias.apelido as apelido_conta_bancaria, fin_forma_transacao.nome as nome_forma_transacao, fin_dados_financeiros.nome as nome_dado_financeiro, ci_funcionarios.nome as FUNCIONARIO');
        ...
        $this->db->join('ci_funcionarios', 'fin_fluxo.id_funcionario = ci_funcionarios.id', 'left');
