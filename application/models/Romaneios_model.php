...
class Romaneios_model extends CI_Model
{
    ...
    {
        $this->db->select('R.data_romaneio, R.id as ID_ROMANEIO, R.criado_em, R.codigo, R.status, F.nome as RESPONSAVEL, F.id as ID_RESPONSAVEL, F.saldo, R.id_setor_empresa');
        $this->db->from('ci_romaneios R');
