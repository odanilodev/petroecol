        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.success) {
                    ...
                    avisoRetorno('Sucesso!', `${data.message}`, 'success', `${baseUrl}dicionario/chavesGlobais`);
        ...
        if (result.isConfirmed) {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    avisoRetorno('Sucesso!', 'Dicionario deletado com sucesso!', 'success', `${baseUrl}dicionario/chavesGlobais`);
